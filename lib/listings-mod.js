...
// ACTUALLY DELETE listing from DB
const actuallyDeleteListingByID = function(listingID) {
...
// add favourite to listing
const addFavouriteToListing = function(listingID, userID) {
