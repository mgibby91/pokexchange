...
//added by Marisa
// get all messages for specific listing by both users
const getAllMessagesForListingIDBySpecificUsers = function(userID, otherUserID, listingID, limit = 100, offset = 0) {

  const values = [userID, otherUserID, listingID, limit, offset];
