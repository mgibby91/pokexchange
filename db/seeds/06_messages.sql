...
insert into messages
  (buyer_id, seller_id, text_body, time_sent, written_by, active, listing_id)
values
  (2, 1, 'That seems extremely fair to me. We have a deal!', '2020-08-17T09:21:32Z', 2, true, 1);
insert into messages
  (buyer_id, seller_id, text_body, time_sent, written_by, active, listing_id)
values
  (2, 1, 'But first, before you buy it you must hear a joke from me.', '2020-08-17T20:13:50Z', 1, true, 1);
insert into messages
  (buyer_id, seller_id, text_body, time_sent, written_by, active, listing_id)
values
  (2, 1, 'Yes, yes. Standard protocol. Of course.', '2020-08-18T10:18:53Z', 2, true, 1);
insert into messages
  (buyer_id, seller_id, text_body, time_sent, written_by, active, listing_id)
values
...
insert into messages
  (buyer_id, seller_id, text_body, time_sent, written_by, active, listing_id)
values
  (2, 1, 'Because Weedle get you high!', '2020-08-20T14:04:55Z', 1, true, 1);
insert into messages
  (buyer_id, seller_id, text_body, time_sent, written_by, active, listing_id)
values
